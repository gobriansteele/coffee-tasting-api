...
from app.api.v1.endpoints import coffees, flavors, health, identification, me, recommendations, roasters, tastings
...
api_router.include_router(identification.router, prefix="/identify-coffee", tags=["identification"])
